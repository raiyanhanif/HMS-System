...
<body>
    ...
    <div class="main-part container-fluid" style="background-image: url('images/benner1.jpg');">
        <div class="row">
            <div class="col-8 crouse " style="padding: 80px;">
                <div class="para ms-5">
                    <h2 class="text-white">IN HOUSE PHARMACY</h2>
                    <p class="text-white"><i class="zmdi zmdi-home"></i> / FACILITES / In House Pharmacy                  </p>
                </div>
    ...
    <div class="mahajan_md container">
        <div class="row pt-5 mt-4 mb-5 pb-4">
            <div class="col-md-8">
                <p>Mahajan Hospital has a 24x7 in house pharmacy within hospital premises which provides round-the-clock service to inpatients and also to the patients who are coming into the hospital on an outpatient basis.</p>
            ...
            <div class=" col-md-4 ">
                <img src="images/house-pharmacy.jpg" class="w-100" alt="mahajan_md " height="350">
                <?php  
                    include 'link1.php';
