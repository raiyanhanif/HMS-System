...
if(isset($_POST['add_pat_tran']))
{
     ...
     $sql="UPDATE hms_patient SET feedback='$feedback' WHERE pat_number='$pat_number' ";
     $result=mysqli_query($conn,$sql);
     if($result)
     {
         ?>
          <script>
              window.location.replace('his_admin_patient_transfer.php');
          </script>
         <?php
     }
     else
                    ...
                    <form action="<?php $_SERVER['PHP_SELF']; ?>" method="post">
                        ...
                        <div class="row ps-3 pe-3 pb-3">
                            ...
                            <div class="form-group col-md-12">
                                <label for="inputPassword4" class="col-form-label w-100">Patient Feedback</label>
                                <textarea name="feedback" id="" class="w-100"  required="required" placeholder=" Prescription`s Decription"></textarea>
                            </div>
                        ...
                        <button type="submit" name="add_pat_tran" class="ladda-button btn btn-success mt-3 px-3 ms-3"
                            data-style="expand-right">Add Feedback</button>
