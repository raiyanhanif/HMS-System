...
if(isset($_POST['search']))
{
  ...
  $sql="SELECT * FROM hms_laboratory WHERE lab_id LIKE '%$search' OR lab_name LIKE '%$search' OR lab_email LIKE '%$$search' OR lab_join_date LIKE '%$search' OR lab_phone LIKE '%$search' OR lab_number LIKE '%$search' ";
  $result=mysqli_query($conn,$sql) or die("Unsuccessfully....!");
}
else
{
  $sql="SELECT * FROM hms_laboratory ORDER By lab_id ASC LIMIT $starting_record,$records_per_page";
  $result=mysqli_query($conn,$sql) or die("Unsuccessfully....!");
}
        ...
        <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
              ...
              <li class="nav-item">
                <a class="nav-link" href="his_admin_add_laboratory.php">Add Lab Person</a>
              </li>
            ...
            <table cellspacing="0" border="1" width="100%" cellpadding="0">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                  <span><a style="text-decoration:none; color:orange" href="his_admin_update_laboratory.php?id=<?=$row['lab_id'];?>"><i class="fa fa-edit fs-4"></i></a></span>&nbsp;&nbsp;&nbsp;&nbsp;
                    <span><a style="text-decoration:none; color:red" href="his_admin_delete_laboratory.php?id=<?=$row['lab_id'];?>" onclick="return del() "><i class="fa fa-trash-o fs-4"></i></a></span>
