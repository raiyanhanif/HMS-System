                ...
                <div class="row mt-5">
                    ...
                    <form action="<?php $_SERVER['PHP_SELF']; ?>" method="post">
                        ...
                        <div class="row ps-3 pe-3 pb-3">
                            <div class="form-group col-md-6">
                                ...
                                <input type="date" required="required" name="lab_join_date" class="form-control"
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input required="required" type="text" name="lab_phone" class="form-control"
                        ...
                        <button type="submit" name="add_laboratory" class="ladda-button btn btn-success mt-3 px-3 ms-3"
                            data-style="expand-right">Add laboratory</button>
                    ...
                    <?php
                       if(isset($_POST['add_laboratory']))
                       {
                            ...
                            $sql1="SELECT * FROM hms_laboratory WHERE lab_email='$lab_email' Or lab_phone='$lab_phone'";
                                ...
                                ?>
                                  <script>
                                      alert("He Is Already Available In Our Website");
                                        window.location.replace('his_admin_add_laboratory.php');
                            ...
                            {
                                $sql="INSERT INTO hms_laboratory (lab_email,lab_name, lab_password, lab_join_date, lab_phone, lab_number) VALUES('$lab_email','$lab_name', '$lab_password', '$lab_join_date', '$lab_phone', '$lab_number' )";
