...
if(isset($_POST['search']))
{
  ...
  $sql="SELECT * FROM hms_employee WHERE emp_id LIKE '%$search' OR emp_fname LIKE '%$search' OR emp_lname  LIKE '%$$search' OR emp_number LIKE '%$search' OR  emp_dob LIKE '%$search' OR emp_email LIKE '%$search' OR emp_phone  LIKE '%$search' OR emp_join_date LIKE '%$search' OR emp_number LIKE '%$search'  ";
  $result=mysqli_query($conn,$sql) or die("Unsuccessfully....!");
}
else
{
  $sql="SELECT * FROM hms_employee ORDER By emp_id ASC LIMIT $starting_record,$records_per_page";
  $result=mysqli_query($conn,$sql) or die("Unsuccessfully....!");
}
        ...
        <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
              ...
              <li class="nav-item">
                <a class="nav-link" href="his_admin_add_employee.php">Add Employee</a>
              </li>
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    ...
                    <span><a style="text-decoration:none; color:orange" href="his_admin_update_employee.php?id=<?=$row['emp_id'];?>"><i class="fa fa-edit fs-4"></i></a></span>&nbsp;&nbsp;&nbsp;&nbsp;
                    <span><a style="text-decoration:none; color:red" href="his_admin_delete_employee.php?id=<?=$row['emp_id'];?>" onclick="return del() "><i class="fa fa-trash-o fs-4"></i></a></span>
