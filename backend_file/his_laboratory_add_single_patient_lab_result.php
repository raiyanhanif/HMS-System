...
include 'his_admin_header.php';
 ...
 if(isset($_POST['add_labtest']))
 {
    ...
    $lab_pat_result=mysqli_real_escape_string($conn,$_POST['lab_pat_result']);
 

    $sql="UPDATE hms_labtest SET lab_pat_result='$lab_pat_result' ";
    ...
    if($result)
    {
        ...
        <script>
            window.location.replace('his_admin_add_patinet_lab_result.php');
        </script>
        <?php
    }
    ...
    <div class="container-fluid mt-5">
            <div class="row head_title ">
                    ...
                    <div class="offset-4 col-md-4">
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item"><a href="his_admin_add_patinet_lab_result.php">Laboratory</a></li>
            ...
            <div class="container form bg-white ">
                ...
                <?php  
                  ...
                  $sql="SELECT * FROM hms_labtest WHERE lab_number='$lab_pat_number'";
                    ...
                    <form action="<?php $_SERVER['PHP_SELF'];?>" method="POST">
                        <div class="row ps-3 pe-3 pb-3 ">
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" required="required" name="lab_pat_name" readonly value="<?=$row['lab_pat_name'];?> " class="form-control"
                                    id="inputEmail4" placeholder="Patient's First Name">
                            </div>
                            <div class="form-group col-md-6">
                                <label for="inputPassword4" class="col-form-label">Ailment</label>
                                <input required="required" type="text" name="lab_pat_ailment" readonly value="<?=$row['lab_pat_ailment'];?>" class="form-control"
                        ...
                        <div class="row ps-3 pe-3 pb-3 ">
                            <div class="form-group col-md-12">
                                ...
                                <input type="text" required="required" name="lab_pat_number" readonly value="<?=$row['lab_pat_number'];?>" class="form-control"
                                    id="inputEmail4" placeholder="Patient's First Name">
                            </div>
                        </div>
                        ...
                        <div class="row ps-3 pe-3 pb-3 ">
                            <div class="form-group col-md-12">
                                ...
                                <textarea name="lab_pat_test" id="" class="w-100"  required="required" placeholder=" Lab Decription"><?=$row['lab_pat_test'];?></textarea>
                        ...
                        <div class="row ps-3 pe-3 pb-3 ">
                            <div class="form-group col-md-12">
                                ...
                                <label for="inputPassword4" class="col-form-label w-100">Lab Test Description</label>
                                <textarea name="lab_pat_result" id="" class="w-100"  required="required" placeholder=" Lab Decription"></textarea>
                        ...
                        <button type="submit" name="add_labtest" class="ladda-button btn btn-success mt-3 px-3 ms-3"
                            data-style="expand-right">Add lab Result</button>
